...
Vagrant.configure("2") do |config|
  ...
  config.vm.define VM1 do |server|
    ...
    ##server.vm.provision "CopyVideo", type: "file", source: "videos/1.mp4", destination: "/home/vagrant/", run: "always"
    ...
    # Copy video into NFS directory
    ##server.vm.provision "CopyVideo", type: "file", source: "videos/1.mp4", destination: "/mnt/mirror/"
